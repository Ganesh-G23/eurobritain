...
{
    private function associateId(): int
    {
        return (int) data_get(session('associate'), 'id', 0);
    }

    private function ownClientQuery()
    {
        return Client::query()->where('associate_id', $this->associateId());
    }

    private function findOwnClientOrFail(int $clientId): Client
    {
        return $this->ownClientQuery()->findOrFail($clientId);
    }

    private function ownApplicationQuery()
    {
        return CertificateApplication::query()
            ->whereHas('client', function ($query) {
                $query->where('associate_id', $this->associateId());
            });
    }
    ...
    public function list(Request $request)
    {
        ...
        $query = $this->ownApplicationQuery()
            ->with([
        ...
        return view('associate.certificate_application.list', [
    ...
    public function checkClient(Request $request)
    {
        ...
        $client = $this->findOwnClientOrFail($clientId);
    ...
    public function saveDocuments(Request $request)
    {
        ...
        $this->findOwnClientOrFail($clientId);
    ...
    public function applicationForm(Request $request)
    {
        ...
        return view('associate.certificate_application.form', $data);
    }
    ...
    public function saveApplication(Request $request)
    {
        ...
        $client = $this->findOwnClientOrFail((int) $request->input('client_id'));
        ...
        $this->response['redirect_url'] = url('certificate-application/list');
    ...
    {
        $application = $this->ownApplicationQuery()->find($id);
        if (! $application) {
    ...
    public function view($id)
    {
        ...
        return view('associate.certificate_application.view', $data);
    }
    ...
    {
        $application = $this->ownApplicationQuery()->findOrFail($id);
        ...
        return view('associate.certificate_application.documents', $data);
    }
    ...
    public function uploadDocument($id)
    {
        ...
        return view('associate.certificate_application.upload_document', $data);
    }
