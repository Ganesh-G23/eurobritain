        ...
        <div class="card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <div class="d-flex gap-2">
                    <a href="{{ url('admin/certificate-application/edit/' . $details->id) }}" class="btn btn-primary btn-sm">Edit</a>
            ...
            <div class="card-body">
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <label class="form-label text-muted mb-1">Application Type</label>
                        <p class="mb-0 fw-medium">{{ ($typeOptions ?? [])[$details->type ?? ''] ?? strtoupper($details->type ?: '—') }}</p>
                    </div>
                    <div class="col-md-6">
