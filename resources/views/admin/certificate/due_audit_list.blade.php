...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            ...
            <div class="card-body">
                <form method="GET" action="{{ url('admin/certificate/due-audit-list') }}" class="row g-3 mb-4">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ url('admin/certificate/due-audit-list') }}" class="btn btn-label-secondary">Reset</a>
                    </div>
                </form>
                        ...
                        <tbody>
                            @forelse ($rows as $index => $row)
                                <tr>
                                    ...
                                    <td>
                                        @if ($row->audit_expiry_date)
                                            {{ $row->audit_expiry_date->format('d M Y') }}
                                        @else
                                            <span class="badge bg-label-warning">Audit due</span>
                                        @endif
                                    </td>
                                    <td class="text-center">
                                        <a href="{{ url('admin/certificate/audit?application_id=' . $row->id) }}"
                                            class="btn btn-sm btn-warning">Audit</a>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="7" class="text-center text-muted py-4">No due audits found.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
