    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="card">
            <div class="card-header d-flex flex-wrap justify-content-between align-items-center gap-2">
                ...
                <a href="{{ url('certificate-application/add') }}" class="btn btn-primary btn-sm">
                    <i class="icon-base ti tabler-plus me-1"></i> Create applications
                </a>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ url('certificate-application/list') }}" class="row g-3 mb-4">
                    <div class="col-md-3">
                    ...
                    <div class="col-md-3 d-flex gap-2">
                        ...
                        <a href="{{ url('certificate-application/list') }}" class="btn btn-success">Refresh</a>
                    </div>
                </form>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex flex-wrap gap-1 justify-content-center">
                                            ...
                                            <a href="{{ url('certificate-application/upload-document/' . $row->id) }}"
