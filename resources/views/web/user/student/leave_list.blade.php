            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                        <h5 class="mb-0">{{ $title ?? 'Leave list' }}</h5>
                        <a href="{{ url('user/student/leave/request') }}" class="btn btn-sm btn-primary">Request leave</a>
                    </div>
                    <div class="table-responsive">
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="8" class="text-center text-body-secondary py-4">No leave requests
                                            yet.</td>
                                    </tr>
                                @endforelse
                            </tbody>
