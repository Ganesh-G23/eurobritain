				...
				<div class="card-body">
					...
					@if(($students ?? collect())->count() === 0)
						<div class="card-teacher">
							...
							<div class="card-sub">Please contact your institute or the respective teacher to link students.</div>
						</div>
					@else
							...
							<div class="card-teacher">
								<div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
									<div class="flex-grow-1">
										...
										@if($s->student_email)<div class="card-sub">Email: {{ $s->student_email }}</div>@endif
										@if($s->student_phone)<div class="card-sub">Phone: {{ $s->student_phone }}</div>@endif
										@if($s->batch_name)<div class="card-sub">Batch: {{ $s->batch_name }}</div>@endif
										@if($s->classroom_name)<div class="card-sub">Classroom: {{ $s->classroom_name }}</div>@endif
									</div>
									<div>
