                ...
                <div class="content-wrapper d-flex flex-column">
                    <nav class="layout-navbar navbar navbar-expand-xl align-items-center border-bottom" id="layout-navbar">
                        <div class="container-xxl d-flex align-items-center justify-content-between w-100 py-2">
                            ...
                            @endphp
                            <a href="{{ url('user/select-student') }}" class="d-flex align-items-center">
                        ...
                        <div class="select-teacher-sheet">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="select-teacher-greet">Hello {{ $parent['name'] ?? 'Parent' }}</div>
                                    <div class="select-teacher-page-title">Select Your Student</div>
                                    <div class="select-teacher-subtext">Choose a student to access their portal.</div>

                                    @if (($students ?? collect())->count() === 0)
                                        <div class="card-teacher">
                                            <div class="teacher-row-title">No students linked yet</div>
                                            <div class="teacher-row-sub">Please contact your institute or the respective
                                                teacher to link students.</div>
                                        </div>
                                    @else
                                            ...
                                            <div class="card-teacher">
                                                <div class="d-flex align-items-center justify-content-between gap-3 flex-wrap">
                                                    <div class="flex-grow-1">
                                                        <div class="teacher-row-title">{{ $s->student_name }}</div>
                                                        @if ($s->student_email)
                                                            <div class="teacher-row-sub">Email: {{ $s->student_email }}</div>
                                                        @endif
                                                        @if ($s->student_phone)
                                                            <div class="teacher-row-sub">Phone: {{ $s->student_phone }}</div>
                                                        @endif
                                                        @if ($s->batch_name)
                                                            <div class="teacher-row-sub">Batch: {{ $s->batch_name }}</div>
                                                        @endif
                                                        @if ($s->classroom_name)
                                                            <div class="teacher-row-sub">Classroom: {{ $s->classroom_name }}</div>
                                                        @endif
                                                    </div>
                                                    <div>
