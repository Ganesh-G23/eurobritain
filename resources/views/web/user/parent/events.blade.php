...
@push('after_calendar_events_seed')
    <script>
        (function() {
            var el = document.getElementById('parent-calendar-feed-json');
            if (!el) {
                return;
            }
            var portal = [];
...
@section('content')
    <script type="application/json" id="parent-calendar-feed-json">@json($calendar_events ?? [])</script>
    <div class="container-xxl flex-grow-1 container-p-y pb-2" data-student-events-readonly="1">
        @if ($student ?? null)
            <p class="text-body-secondary small mb-3">
                Events for <strong>{{ $student->name }}</strong> from every teacher they are enrolled with (by
                classroom and batch).
            </p>
        @endif
                    ...
                    <div class="offcanvas offcanvas-end event-sidebar" tabindex="-1" id="viewEventSidebar"
                        ...
                        <div class="offcanvas-body">
                            <div class="pt-0">
                                ...
                                <div class="mb-4 d-none" id="viewEventStudentRow">
