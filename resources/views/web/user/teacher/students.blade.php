			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="studentEnrollmentsForm">
						...
						<p class="text-body-secondary small">Add at most one row per classroom (one batch per classroom). The first row sets the student&apos;s primary classroom and batch.</p>
