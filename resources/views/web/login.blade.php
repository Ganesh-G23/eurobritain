                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="enquay-form-section bg-white">
                                ...
                                @if (session('password_reset_ok'))
                                    <div class="alert alert-success mb-3">Your password has been reset. You can sign in below.</div>
                                @endif
                                <div class="form-container">
                                    ...
                                    <div class="step">
                                        <form id="login-form" class="form-horizontal"
                                            action="{{ route('web.login.submit') }}" method="POST">
                                            @csrf
                                        ...
                                        <button type="button" id="prev-step-btn" class="back-btn w-100"><img
                                                width="13" height="13"
                                                src="https://img.icons8.com/ios-filled/100/back.png"
                                                alt="back" /></button>
                                        <button type="button" id="submit-login-btn"
                                            class="btn-main w-100 submit-button">Submit</button>
                                    </div>
                                </div>
                            </div>
                        </div>
